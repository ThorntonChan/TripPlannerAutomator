...
//    @And("the city (.*?) has been selected")
    ...
    @And("the city {string} has been selected")
    public void theCityHasBeenSelected1(String city) {
        AddressGenerator_Service.changeCity(city);
    }
    ...
    @When("{string} and {string} are input as destinations")
    public void fromAndToAreInputAsDestinations1(String from, String to) {
        TransportRoute_Service.inputDestinations(to, from);
    }
